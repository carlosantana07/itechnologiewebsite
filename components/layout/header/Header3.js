                    ...
                    <div className="main-header-two__top-inner">
                        <ul className="list-unstyled main-header-three__contact-list">
                            <li>
                                ...
                                <div className="text">
                                    <p><Link href="tel:926668880000">+226 79 05 02 02</Link></p>
                                </div>
                            </li>
                            <li>
                                <div className="icon">
                                ...
                                <div className="text">
                                    <p><Link href="mailto:hello@gardon.com">info@itechnologiesa.ca</Link></p>
                                </div>
                            </li>
                        </ul>
                        <div className="main-header-two__social-box">
                            <p className="main-header-two__social-title">Nos Réseaux</p>
